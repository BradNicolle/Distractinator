...
public class OverlayService extends Service {
	...
	public void onCreate() {
		...
		// Create notification to prevent the service being killed in low memory situations
		Notification note = new Notification.Builder(this)
				.setContentTitle("Distractinator active!")
	...
	public void hide(View v) {
		...
		// Get a callback to make us visible when time is up
		(new Timer()).schedule(new TimerTask() {
			public void run() {
